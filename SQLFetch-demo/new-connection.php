...
define('DB_USER', 'root');
//define('DB_PASS', 'Ngtr432!'); //may need to set DB_PASS as 'root'
define('DB_PASS', 'password'); //may need to set DB_PASS as 'root'
define('DB_DATABASE', 'contact'); //make sure to set your database
...
function run_mysql_query2($query)
{
    global $connection;
    ...
    //Return boolean (true/false) if query is update or delete
    return $result;
}
